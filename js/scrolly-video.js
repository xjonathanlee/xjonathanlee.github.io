var ScrollyVideo = (function () {
                ...
                Y = function (t, e) {
                    for (var i in e)
                        if (typeof e[i] === a && e[i].length > 0) {
                            for (var r = 0; r < e[i].length; r++) if (O(e[i][r], t)) return "?" === i ? s : i;
                        } else if (O(e[i], t)) return "?" === i ? s : i;
                    return t;
                },
                j = { ME: "4.90", "NT 3.11": "NT3.51", "NT 4.0": "NT4.0", 2e3: "NT 5.0", XP: ["NT 5.1", "NT 5.2"], Vista: "NT 6.0", 7: "NT 6.1", 8: "NT 6.2", 8.1: "NT 6.3", 10: ["NT 6.4", "NT 10.0"], RT: "ARM" },
                q = {
                    browser: [
                        [/\b(?:crmo|crios)\/([\w\.]+)/i],
                        [f, [d, "Chrome"]],
                        ...
                        [d, [f, Y, { "1.0": "/8", 1.2: "/1", 1.3: "/3", "2.0": "/412", "2.0.2": "/416", "2.0.3": "/417", "2.0.4": "/419", "?": "/" }]],
                        [/(webkit|khtml)\/([\w\.]+)/i],
                        [d, f],
        ...
        (a.prototype.readInt64 = function () {
            ...
            (a.prototype.writeInt32Array = function (t, e) {
                if ((this._realloc(4 * t.length), t instanceof Int32Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapInt32Array(t.length, e);
            ...
            (a.prototype.writeInt16Array = function (t, e) {
                if ((this._realloc(2 * t.length), t instanceof Int16Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapInt16Array(t.length, e);
            ...
            (a.prototype.writeInt8Array = function (t) {
                if ((this._realloc(1 * t.length), t instanceof Int8Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapInt8Array(t.length);
            ...
            (a.prototype.writeUint32Array = function (t, e) {
                if ((this._realloc(4 * t.length), t instanceof Uint32Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapUint32Array(t.length, e);
            ...
            (a.prototype.writeUint16Array = function (t, e) {
                if ((this._realloc(2 * t.length), t instanceof Uint16Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapUint16Array(t.length, e);
            ...
            (a.prototype.writeUint8Array = function (t) {
                if ((this._realloc(1 * t.length), t instanceof Uint8Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapUint8Array(t.length);
            ...
            (a.prototype.writeFloat64Array = function (t, e) {
                if ((this._realloc(8 * t.length), t instanceof Float64Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapFloat64Array(t.length, e);
            ...
            (a.prototype.writeFloat32Array = function (t, e) {
                if ((this._realloc(4 * t.length), t instanceof Float32Array && this.byteOffset + (this.position % t.BYTES_PER_ELEMENT) === 0))
                    a.memcpy(this._buffer, this.byteOffset + this.position, t.buffer, 0, t.byteLength), this.mapFloat32Array(t.length, e);
        ...
        ((h.prototype = new a(new ArrayBuffer(), 0, a.BIG_ENDIAN)).initialized = function () {
            ...
            return (
                ...
                (this.buffers.length > 0
                    ? 0 === (t = this.buffers[0]).fileStart
                        ? ((this.buffer = t), (this.bufferIndex = 0), r.debug("MultiBufferStream", "Stream ready for parsing"), !0)
                        : (r.warn("MultiBufferStream", "The first buffer should have a fileStart of 0"), this.logBufferLevel(), !1)
            ...
            (h.prototype.logBufferLevel = function (t) {
                ...
                for (s = 0, n = 0, e = 0; e < this.buffers.length; e++)
                    (i = this.buffers[e]),
                        0 === e
                            ? ((a = {}), o.push(a), (a.start = i.fileStart), (a.end = i.fileStart + i.byteLength), (h += "[" + a.start + "-"))
                            : a.end === i.fileStart
                            ? (a.end = i.fileStart + i.byteLength)
                            : (((a = {}).start = i.fileStart), (h += o[o.length - 1].end - 1 + "], [" + a.start + "-"), (a.end = i.fileStart + i.byteLength), o.push(a)),
                        (s += i.usedBytes),
                        (n += i.byteLength);
            ...
            (h.prototype.findPosition = function (t, e, i) {
                ...
                for (s = !0 === t ? 0 : this.bufferIndex; s < this.buffers.length && (n = this.buffers[s]).fileStart <= e; )
                    (a = s), i && (n.fileStart + n.byteLength <= e ? (n.usedBytes = n.byteLength) : (n.usedBytes = e - n.fileStart), this.logBufferLevel()), s++;
            ...
            (h.prototype.seek = function (t, e, i) {
                ...
                return -1 !== (s = this.findPosition(e, t, i))
                    ? ((this.buffer = this.buffers[s]), (this.bufferIndex = s), (this.position = t - this.buffer.fileStart), r.debug("MultiBufferStream", "Repositioning parser at buffer position: " + this.position), !0)
        ...
        l.initialize(),
            ...
            (l.parseOneBox = function (t, e, i) {
                var s,
                    ...
                    o = t.getPosition(),
                    h = 0;
                if (t.getEndPosition() - o < 8) return r.debug("BoxParser", "Not enough data in stream to parse the type and size of the box"), { code: l.ERR_NOT_ENOUGH_DATA };
                if (i && i < 8) return r.debug("BoxParser", "Not enough bytes left in the parent box to parse a new box"), { code: l.ERR_NOT_ENOUGH_DATA };
                var d = t.readUint32(),
                    p = t.readString(4),
                    f = p;
                if ((r.debug("BoxParser", "Found box of type '" + p + "' and size " + d + " at position " + o), (h = 8), "uuid" == p)) {
                    if (t.getEndPosition() - t.getPosition() < 16 || i - h < 16) return t.seek(o), r.debug("BoxParser", "Not enough bytes left in the parent box to parse a UUID box"), { code: l.ERR_NOT_ENOUGH_DATA };
                    (h += 16), (f = a = l.parseUUID(t));
                }
                if (1 == d) {
                    if (t.getEndPosition() - t.getPosition() < 8 || (i && i - h < 8)) return t.seek(o), r.warn("BoxParser", 'Not enough data in stream to parse the extended size of the "' + p + '" box'), { code: l.ERR_NOT_ENOUGH_DATA };
                    (d = t.readUint64()), (h += 8);
                } else if (0 === d)
                    if (i) d = i;
                    else if ("mdat" !== p) return r.error("BoxParser", "Unlimited box size not supported for type: '" + p + "'"), (s = new l.Box(p, d)), { code: l.OK, box: s, size: s.size };
                return d < h
                    ? (r.error("BoxParser", "Box of type " + p + " has an invalid size " + d + " (too small to be a box)"), { code: l.ERR_NOT_ENOUGH_DATA, type: p, size: d, hdr_size: h, start: o })
                    : i && d > i
                    ? (r.error("BoxParser", "Box of type '" + p + "' has a size " + d + " greater than its container size " + i), { code: l.ERR_NOT_ENOUGH_DATA, type: p, size: d, hdr_size: h, start: o })
                    : o + d > t.getEndPosition()
                    ? (t.seek(o), r.info("BoxParser", "Not enough data in stream to parse the entire '" + p + "' box"), { code: l.ERR_NOT_ENOUGH_DATA, type: p, size: d, hdr_size: h, start: o })
                    : e
                    ? { code: l.OK, type: p, size: d, hdr_size: h, start: o }
                    : (l[p + "Box"]
                          ? (s = new l[p + "Box"](d))
                          : "uuid" !== p
                          ? (r.warn("BoxParser", "Unknown box type: '" + p + "'"), ((s = new l.Box(p, d)).has_unparsed_data = !0))
                          : l.UUIDBoxes[a]
                          ? (s = new l.UUIDBoxes[a](d))
                          : (r.warn("BoxParser", "Unknown uuid type: '" + a + "'"), ((s = new l.Box(p, d)).uuid = a), (s.has_unparsed_data = !0)),
                      (s.hdr_size = h),
                      (s.start = o),
                      s.write === l.Box.prototype.write && "mdat" !== s.type && (r.info("BoxParser", "'" + f + "' box writing not yet implemented, keeping unparsed data in memory for later write"), s.parseDataAndRewind(t)),
                      s.parse(t),
                      (n = t.getPosition() - (s.start + s.size)) < 0
                          ? (r.warn("BoxParser", "Parsing of box '" + f + "' did not read the entire indicated box data size (missing " + -n + " bytes), seeking forward"), t.seek(s.start + s.size))
                          : n > 0 && (r.error("BoxParser", "Parsing of box '" + f + "' read " + n + " more bytes than the indicated box data size, seeking backwards"), t.seek(s.start + s.size)),
            ...
            l.createFullBoxCtor("infe", function (t) {
                if (
                    ...
                    return (this.extension_type = t.readString(4)), r.warn("BoxParser", "Cannot parse extension type"), void t.seek(this.start + this.size);
                this.version >= 2 &&
            ...
            l.createFullBoxCtor("iref", function (t) {
                ...
                for (this.references = []; t.getPosition() < this.start + this.size; ) {
                    ...
                    (i = 0 === this.version ? new l.SingleItemTypeReferenceBox(e.type, e.size, e.hdr_size, e.start) : new l.SingleItemTypeReferenceBoxLarge(e.type, e.size, e.hdr_size, e.start)).write === l.Box.prototype.write &&
                        "mdat" !== i.type &&
                        (r.warn("BoxParser", i.type + " box writing not yet implemented, keeping unparsed data in memory for later write"), i.parseDataAndRewind(t)),
                        i.parse(t),
            ...
            l.createFullBoxCtor("mehd", function (t) {
                1 & this.flags && (r.warn("BoxParser", "mehd box incorrectly uses flags set to 1, converting version to 1"), (this.version = 1)),
            ...
            l.createFullBoxCtor("stsd", function (t) {
                ...
                for (this.entries = [], s = t.readUint32(), e = 1; e <= s; e++) {
                    ...
                    l[i.type + "SampleEntry"]
                        ? (((n = new l[i.type + "SampleEntry"](i.size)).hdr_size = i.hdr_size), (n.start = i.start))
                        : (r.warn("BoxParser", "Unknown sample entry type: " + i.type), (n = new l.SampleEntry(i.type, i.size, i.hdr_size, i.start))),
                        n.write === l.SampleEntry.prototype.write && (r.info("BoxParser", "SampleEntry " + n.type + " box writing not yet implemented, keeping unparsed data in memory for later write"), n.parseDataAndRewind(t)),
                        n.parse(t),
                        this.entries.push(n);
                }
            }),
            ...
            l.createFullBoxCtor("stts", function (t) {
                ...
                if (((e = t.readUint32()), (this.sample_counts = []), (this.sample_deltas = []), 0 === this.version))
                    for (i = 0; i < e; i++)
                        this.sample_counts.push(t.readUint32()), (s = t.readInt32()) < 0 && (r.warn("BoxParser", "File uses negative stts sample delta, using value 1 instead, sync may be lost!"), (s = 1)), this.sample_deltas.push(s);
            }),
            ...
            l.createFullBoxCtor("tfhd", function (t) {
                ...
                (this.track_id = t.readUint32()),
                    this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_BASE_DATA_OFFSET ? ((this.base_data_offset = t.readUint64()), (e += 8)) : (this.base_data_offset = 0),
                    this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_DESC ? ((this.default_sample_description_index = t.readUint32()), (e += 4)) : (this.default_sample_description_index = 0),
                    this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_DUR ? ((this.default_sample_duration = t.readUint32()), (e += 4)) : (this.default_sample_duration = 0),
                    this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_SIZE ? ((this.default_sample_size = t.readUint32()), (e += 4)) : (this.default_sample_size = 0),
                    this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_FLAGS ? ((this.default_sample_flags = t.readUint32()), (e += 4)) : (this.default_sample_flags = 0);
            }),
            ...
            (l.trefBox.prototype.parse = function (t) {
                for (var e, i; t.getPosition() < this.start + this.size; ) {
                    if ((e = l.parseOneBox(t, !0, this.size - (t.getPosition() - this.start))).code !== l.OK) return;
                    (i = new l.TrackReferenceTypeBox(e.type, e.size, e.hdr_size, e.start)).write === l.Box.prototype.write &&
                        "mdat" !== i.type &&
                        (r.info("BoxParser", "TrackReference " + i.type + " box writing not yet implemented, keeping unparsed data in memory for later write"), i.parseDataAndRewind(t)),
                        i.parse(t),
                        this.boxes.push(i);
                }
            }),
            ...
            l.createFullBoxCtor("trun", function (t) {
                ...
                if (
                    ...
                    (e += 4),
                    this.size - this.hdr_size > e && this.flags & l.TRUN_FLAGS_DATA_OFFSET ? ((this.data_offset = t.readInt32()), (e += 4)) : (this.data_offset = 0),
                    this.size - this.hdr_size > e && this.flags & l.TRUN_FLAGS_FIRST_FLAG ? ((this.first_sample_flags = t.readUint32()), (e += 4)) : (this.first_sample_flags = 0),
            ...
            (l.Box.prototype.writeHeader = function (t, e) {
                (this.size += 8),
                    ...
                    this.size > o ? t.writeUint32(1) : ((this.sizePosition = t.getPosition()), t.writeUint32(this.size)),
            ...
            (l.trunBox.prototype.write = function (t) {
                (this.version = 0),
                    ...
                    this.flags & l.TRUN_FLAGS_DATA_OFFSET && ((this.data_offset_position = t.getPosition()), t.writeInt32(this.data_offset)),
        ...
        (u.prototype.setSegmentOptions = function (t, e, i) {
            ...
            (u.prototype.checkBuffer = function (t) {
                ...
                return 0 === t.byteLength
                    ? (r.warn("ISOFile", "Ignoring empty buffer (fileStart: " + t.fileStart + ")"), this.stream.logBufferLevel(), !1)
                            ...
                            for (i = a.trak; i.nextSample < i.samples.length && this.sampleProcessingStarted; ) {
                                ...
                                if (
                                    ...
                                    (i.nextSample % a.nb_samples == 0 || i.nextSample >= i.samples.length) &&
                                        (r.debug("ISOFile", "Sending samples on track #" + a.id + " for sample " + i.nextSample), this.onSamples && this.onSamples(a.id, a.user, a.samples), (a.samples = []), a !== this.extractedTracks[e]))
                                )
                                    break;
                            }
                        }
            ...
            (u.prototype.seekTrack = function (t, e, i) {
                var s,
                    ...
                    h = 0,
                    d = 0;
                if (0 === i.samples.length) return r.info("ISOFile", "No sample in track, cannot seek! Using time " + r.getDurationString(0, 1) + " and offset: 0"), { offset: 0, time: 0 };
            ...
            (u.prototype.seek = function (t, e) {
                ...
                if (this.moov) {
                    ...
                    return (
                        ...
                        o.offset === 1 / 0 ? (o = { offset: this.nextParsePosition, time: 0 }) : (o.offset = this.stream.getEndFilePositionAfter(o.offset)),
                ...
                if (
                    ...
                    for (e = 0; e < r.sample_sizes.length; e++) {
                        ...
                        (B.number = e),
                            ...
                            0 === e
                                ? ((m = 1), (c = 0), (B.chunk_index = m), (B.chunk_run_index = c), (y = s.samples_per_chunk[c]), (g = 0), (_ = c + 1 < s.first_chunk.length ? s.first_chunk[c + 1] - 1 : 1 / 0))
                                : e < y
                                ? ((B.chunk_index = m), (B.chunk_run_index = c))
                                : (m++, (B.chunk_index = m), (g = 0), m <= _ || (_ = ++c + 1 < s.first_chunk.length ? s.first_chunk[c + 1] - 1 : 1 / 0), (B.chunk_run_index = c), (y += s.samples_per_chunk[c])),
                            ...
                            e > 0 ? ((t.samples[e - 1].duration = n.sample_deltas[v]), (t.samples_duration += t.samples[e - 1].duration), (B.dts = t.samples[e - 1].dts + t.samples[e - 1].duration)) : (B.dts = 0),
                            a ? (e >= w && (U++, w < 0 && (w = 0), (w += a.sample_counts[U])), (B.cts = t.samples[e].dts + a.sample_offsets[U])) : (B.cts = B.dts),
                            o
                                ? (e == o.sample_numbers[S] - 1 ? ((B.is_sync = !0), S++) : ((B.is_sync = !1), (B.degradation_priority = 0)),
                                  d && d.entries[x].sample_delta + E == e + 1 && ((B.subsamples = d.entries[x].subsamples), (E += d.entries[x].sample_delta), x++))
                                : (B.is_sync = !0),
                            u.process_sdtp(t.mdia.minf.stbl.sdtp, B, B.number),
                            (B.degradation_priority = f ? f.priority[e] : 0),
                            d && d.entries[x].sample_delta + E == e && ((B.subsamples = d.entries[x].subsamples), (E += d.entries[x].sample_delta)),
                        ...
                        if (((h = this.moofs[this.lastMoofIndex]), this.lastMoofIndex++, "moof" == h.type))
                            for (d = h, t = 0; t < d.trafs.length; t++) {
                                    ...
                                    for (i = 0; i < g.sample_count; i++) {
                                        ((m = {}).moof_number = this.lastMoofIndex),
                                            ...
                                            f.first_traf_merged || i > 0
                                                ? (m.dts = f.samples[f.samples.length - 2].dts + f.samples[f.samples.length - 2].duration)
                                                : (p.tfdt ? (m.dts = p.tfdt.baseMediaDecodeTime) : (m.dts = 0), (f.first_traf_merged = !0)),
                                            (m.cts = m.dts),
                                ...
                                if (p.subs) {
                                    ...
                                    for (e = 0; e < p.subs.entries.length; e++) (U += p.subs.entries[e].sample_delta), ((m = f.samples[U - 1]).subsamples = p.subs.entries[e].subsamples);
                                }
                            }
            }),
                    ...
                    if (n.iloc)
                        for (t = 0; t < n.iloc.items.length; t++) {
                            ...
                            for (i.extents = [], i.size = 0, e = 0; e < a.extents.length; e++)
                                (i.extents[e] = {}), (i.extents[e].offset = a.extents[e].extent_offset + a.base_offset), (i.extents[e].length = a.extents[e].extent_length), (i.extents[e].alreadyRead = 0), (i.size += i.extents[e].length);
                        }
                    if ((n.pitm && (s[n.pitm.item_id].primary = !0), n.iref))
                        for (t = 0; t < n.iref.references.length; t++) {
                            var o = n.iref.references[t];
                            for (e = 0; e < o.references.length; e++) s[o.from_item_ID].ref_to.push({ type: o.type, id: o.references[e] });
                        }
                    if (n.iprp)
            ...
            (u.prototype.initializeSegmentation = function () {
                var t, e, i, s;
                for (
                    null === this.onSegment && r.warn("MP4Box", "No segmentation callback set!"), this.isFragmentationInitialized || ((this.isFragmentationInitialized = !0), (this.nextMoofNumber = 0), this.resetTables()), e = [], t = 0;
            ...
            try {
                ...
                (d.onReady = (t) => {
                    if (t && t.videoTracks && t.videoTracks[0]) {
                        ([{ codec: l }] = t.videoTracks), r && console.info("Video with codec:", l);
                        const e = ((t) => {
                            let e,
                                i = 7;
                        ...
                        p.configure({ codec: l, description: e }), d.setExtractionOptions(t.videoTracks[0].id), d.start();
                    ...
                    (d.onSamples = (t, e, i) => {
                        for (let t = 0; t < i.length; t += 1) {
                            const e = i[t],
                                ...
                                n = new s({ type: r, timestamp: e.cts, duration: e.duration, data: e.data });
                            p.decode(n);
                        }
                    }),
                    fetch(t).then((t) => {
    ...
    return class {
        constructor({ src: t, scrollyVideoContainer: e, cover: i = !0, sticky: s = !0, full: n = !0, trackScroll: a = !0, transitionSpeed: o = 1, frameThreshold: h = 0.1, useWebCodecs: d = !0, debug: l = !1 }) {
            ...
            (this.src = t),
                ...
                n && ((this.container.style.width = "100%"), (this.container.style.height = "100vh"), (this.container.style.overflow = "hidden")),
        ...
        decodeVideo() {
            ...
            this.useWebCodecs &&
                ...
                "function" == typeof VideoDecoder && "function" == typeof EncodedVideoChunk
                    ? (i && console.info("WebCodecs is natively supported, using native version..."), o(t, e, { VideoDecoder: VideoDecoder, EncodedVideoChunk: EncodedVideoChunk, debug: i }))
        ...
        transitionToTargetTime(t) {
            if ((this.debug && console.info("Transitioning targetTime:", this.targetTime, "currentTime:", this.currentTime), isNaN(this.targetTime) || Math.abs(this.currentTime - this.targetTime) < this.frameThreshold))
            ...
            if (this.canvas) (this.currentTime += e / (256 / this.transitionSpeed)), t && (this.currentTime = this.targetTime), this.paintCanvasFrame(Math.floor(this.currentTime * this.frameRate));
                ...
                this.video.pause(), (this.currentTime += e / (64 / this.transitionSpeed)), t && (this.currentTime = this.targetTime), (this.video.currentTime = this.currentTime);
            else {
        ...
        setTargetTimePercent(t, e) {
            (this.targetTime = Math.max(Math.min(t, 1), 0) * (this.frames.length && this.frameRate ? this.frames.length / this.frameRate : this.video.duration)),
                (!e && Math.abs(this.currentTime - this.targetTime) < this.frameThreshold) || (!e && this.transitioning) || (this.canvas || this.video.play(), (this.transitioning = !0), this.transitionToTargetTime(e));
        }
        destroy() {
